...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <meta name="SearchDescription" content="Институт региональной информатизации | Главная страница" scheme />
        <meta name="application-name" content="Институт региональной информатизации" scheme />
    </head>
    ...
    <body>
        ...
        <div class="main-block">
            ...
            <div class="interactive-education">
            </div>
        ...
        <div class="social">
            ...
            <table class="social-in">
                <tbody>
                <tr>
                    <td class="social-img">
                    <img src="img/vk-icon.png" alt="ИРИнф ВКонтакте" width="120" height="120"/>
                        
                    </td>
                    <td class="vk-block">
                    Оставайтесь ВКонтакте с нами!
        ...
        <div class="strip-colored2"></div>
        <div class="strip-gray2"></div>
                        ...
                        <td>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="http://qriteria.ru"><img src="img/qriteria-icon.png" alt="QRiteria.ru"/></a>
                                        </td>
                                        <td>
                                            <a href="http://qriteria.ru">QRитерия.ру</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
